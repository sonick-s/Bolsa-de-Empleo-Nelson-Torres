...
<head>
	...
	<title>EmpleaTec- Experiencia Laboral</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Experiencia laboral</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-experience.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this experience ?')" class="btn btn-primary btn-sm btn-inverse">Borrar</a>
								    ...
								    <label>Nombre de la Empresa <b style="color:#990000">*</b></label>
								    <input value="<?php echo "$institution"; ?>" class="form-control" placeholder="Ingresa Nombre de la empresa" type="text" name="institution" required> 
							        </div>
								    ...
								    <input value="<?php echo "$supervisor"; ?>" class="form-control" placeholder="Ingrese el nombre del jefe inmediato" type="text" name="supervisor"> 
							        </div>
								    ...
								    <input value="<?php echo "$phone"; ?>" class="form-control" placeholder="Ingrese el télefono" type="text" name="telphone"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Cargo <b style="color:#990000">*</b></label>
								    <input  value="<?php echo "$title"; ?>" class="form-control" placeholder="Ingrese el cargo" type="text" name="jobtitle" required> 
							        </div>
								    ...
								    <input  value="<?php echo "$start_date"; ?>" class="form-control" placeholder="Ej: 13-01-2017" type="text" name="startdate" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Fecha de salida <b style="color:#990000">*</b></label>
								    <input  value="<?php echo "$end_date"; ?>" class="form-control" placeholder="Ej: 01-12-2017" type="text" name="enddate" required> 
							        </div>
								...
								?>
							        ...
							        <div class="form-group"> 
								    <label>Nombre de la empresa <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Ingresa Nombre de la empresa" type="text" name="institution" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Jefe inmediato</label>
								    <input class="form-control" placeholder="Ingresa nombre del jefe inmediato" type="text" name="supervisor"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Teléfono</label>
								    <input class="form-control" placeholder="Ingresa teléfono" type="text" name="telphone"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Cargo <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Ingrese el cargo" type="text" name="jobtitle" required> 
							        </div>
								    ...
								    <input class="form-control" placeholder="Ej: 01 March 2017" type="text" name="startdate" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Fecha Salida <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Ej: 01 June 2017" type="text" name="enddate" required> 
							        </div>
