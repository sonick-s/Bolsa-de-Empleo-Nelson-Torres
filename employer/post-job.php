...
<head>
	...
	<title>EmpleaTec - Publicar Vacante</title>
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-8 col-md-8">
													...
													<div class="form-group">
														...
														<input name="title" required type="text" class="form-control" placeholder="Ingrese el nombre de la vacante">
													</div>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label>Ciudad</label>
														<input name="city" required type="text" class="form-control" placeholder="Ingrese ciudad">
													</div>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															<option value="" selected >Seleccionar</option>
															<option value="Expert">Sin experiencia</option>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea class="form-control bootstrap3-wysihtml5" name="description" required placeholder="ingrese la descripción..." style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="responsiblities" required class="form-control bootstrap3-wysihtml5" placeholder="Ingrese responsabilidades..." style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="requirements" required class="form-control bootstrap3-wysihtml5" placeholder="Ingrese requerimientos..." style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-6 mt-30">
													<button type="submit"  onclick = "validate(this)" class="btn btn-primary btn-lg">Publicar vacante</button>
												</div>
