...
<head>
	...
	<title>EmpleaTec - Postulantes <?php echo "$job_title"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Postulantes <?php echo "$job_title"; ?></</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Postulantes <?php echo "$job_title"; ?></</h3>
						</div>
