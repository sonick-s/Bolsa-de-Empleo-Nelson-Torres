...
<head>
	...
	<title>EmpleaTec - Bolsa de Empleo<?php echo "$title"; ?></title>
										...
										<div class="content">
												...
												<div class="row">
													...
													<div class="col-sm-7 col-md-8">
														...
														<div class="meta-div clearfix mb-25">
															<span><a href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$thecompname"; ?></a></span>
															<?php echo "$sta"; ?>
														</div>
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">Ver Vacantes</a>
													</div>
